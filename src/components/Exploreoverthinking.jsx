...
<ol style={{listStyleType:"lower-alpha", }} className='ms-5' > <br />
...
Overthinking is different from problem-solving. <br /> Overthinking is about dwelling on the problem, while problem-solving involves looking
for a solution. <br />
Imagine a storm is coming. Here’s the difference between overthinking and problem-solving: <br /> <br />

<div className='flex bg-blue-50 font-bold '>1.Overthinking: <br /></div>
“I wish the storm wouldn’t come. It’s going to be awful. I hope the house doesn’t get damaged.
Why do these things always have to happen to me? I can’t handle this.” <br />

  <div className=' flex bg-blue-50 font-bold' >Problem-solving: <br /></div>
  <p>
1.
...
</p><p> <span className='font-bold'>
  2.
Experiencing Repetitive Thoughts Ruminating </span>—or rehashing the same things over and over again—isn’t helpful. But, when you’re overthinking, you might find 
