...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-[#0000]">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/*Mobile menu button*/}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-black-900 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                    ...
                    {navigation.map((item) => (
                      <NavLink
                        ...
                        className={classNames(
                          item.current
                            ? " text-black-900 "
                            : "text-black-900  hover:bg-[#22C55E] hover:text-white",
